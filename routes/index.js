  ...
  models['UserInfo'].getAccessToken(req, function (results) {
    ...
    let new_request1 = {
      "recurring_application_charge": {
        ...
        "price": 1.0,
        "return_url": "https://d8dbf920.ngrok.io/shopify/recurring_application_charge_return",
        "test": true,
        "trial_days":1
      }
    };
  ...
  models['UserInfo'].getAccessToken(req, function (results) {
    ...
    let new_request = {
      "recurring_application_charge": {
        ...
        "price":"1.00",
        "status":"accepted",
        "return_url":"https:\/\/b30b2ab6.ngrok.io\/shopify\/recurring_application_charge_return",
        "billing_on":null,
        ...
        "trial_days":0,
        "trial_ends_on":null,
        "decorated_return_url":"https:\/\/b30b2ab6.ngrok.io\/shopify\/recurring_application_charge_return?charge_id=12671320152"
      }
    };
